...
const Experiences = () => (
  <div id="experiences" className="p-8 text-[var(--eerie-black)]">
    <h1 className="text-4xl font-bold text-[var(--eerie-black)] mb-8 text-center">My Journey</h1>
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">CJS Cybersecurity Meetup at Queen's Park</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-4">June 2025</p>
          ...
          <div className="bg-[var(--keppel)]/50 p-4 rounded-lg border-l-4 border-[var(--keppel)]">
            <h3 className="font-bold text-[var(--eerie-black)] mb-2">Hot Topics in Cybersecurity Today:</h3>
          ...
          <a 
            ...
            className="inline-block mt-4 bg-[var(--keppel)] text-[var(--ivory)] font-bold py-2 px-4 rounded-lg hover:bg-[var(--onyx)] transition-all duration-300 transform hover:scale-105"
          >
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Software Engineer at InOrbit</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-4">Jun 2024 - Nov 2024</p>
          <p className="mb-4 text-[var(--eerie-black)]">
          ...
          <div className="bg-[var(--keppel)]/50 p-4 rounded-lg border-l-4 border-[var(--keppel)]">
            <h3 className="font-bold text-[var(--eerie-black)] mb-2">Key Achievements:</h3>
            <ul className="list-disc list-inside text-[var(--eerie-black)] space-y-1">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">🏆 First Place: BEST Startup Experience</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-4">Project: Carbon Report</p>
          <p className="mb-4 text-[var(--eerie-black)]">
          ...
          <div className="bg-[var(--keppel)]/50 p-4 rounded-lg border-l-4 border-[var(--keppel)]">
            <h3 className="font-bold text-[var(--eerie-black)] mb-2">What I Learned:</h3>
            <ul className="list-disc list-inside text-[var(--eerie-black)] space-y-1">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row-reverse items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Software Engineer Intern at InOrbit</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-4">Summer 2021</p>
          <p className="mb-4 text-[var(--eerie-black)]">
          ...
          <div className="bg-[var(--keppel)]/50 p-4 rounded-lg border-l-4 border-[var(--keppel)]">
            <h3 className="font-bold text-[var(--eerie-black)] mb-2">Key Takeaways:</h3>
            <ul className="list-disc list-inside text-[var(--eerie-black)] space-y-1">
