...
const Learning = () => (
  <div id="learning" className="p-8 text-[var(--eerie-black)]">
    <h1 className="text-4xl font-bold text-[var(--eerie-black)] mb-8 text-center">My Learning Journey</h1>
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row-reverse items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Software Engineering at York University</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-4">2018 - 2023</p>
          <p className="mb-4 text-[var(--eerie-black)]">
          ...
          <div className="bg-[var(--keppel)]/50 p-4 rounded-lg border-l-4 border-[var(--keppel)]">
            <h3 className="font-bold text-[var(--eerie-black)] mb-2">Core Learnings:</h3>
            <ul className="list-disc list-inside text-[var(--eerie-black)] space-y-1">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">AWS Certified Solutions Architect</h2>
          <p className="font-semibold text-lg text-[var(--eerie-black)] mb-2">Associate Level</p>
          <p className="text-sm text-[var(--eerie-black)] mb-4">Issued: March 03, 2025</p>
          <p className="mb-4 text-[var(--eerie-black)]">
          ...
          <a 
            ...
            className="inline-block mt-2 bg-[var(--keppel)] text-[var(--ivory)] font-bold py-2 px-4 rounded-lg hover:bg-[var(--onyx)] transition-all duration-300 transform hover:scale-105"
          >
            View Credly Badge
          </a>
        </div>
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Cloud Security</h2>
          <p className="text-sm text-[var(--eerie-black)] mb-4">Issued: June 18, 2025</p>
          <p className="mb-4 text-[var(--eerie-black)]">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Systems and Network Security</h2>
          <p className="text-sm text-[var(--eerie-black)] mb-4">Issued: June 02, 2025</p>
          <p className="mb-4 text-[var(--eerie-black)]">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Vulnerability Management</h2>
          <p className="text-sm text-[var(--eerie-black)] mb-4">Issued: May 23, 2025</p>
          <p className="mb-4 text-[var(--eerie-black)]">
    ...
    <div className="bg-[var(--steel-blue)]/60 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-12 border border-[var(--keppel)]/30">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-[var(--eerie-black)] mb-3">Governance, Risk, Compliance, and Data Privacy</h2>
          <p className="mb-4 text-[var(--eerie-black)]">
    ...
    <div className="bg-[var(--keppel)]/50 p-6 rounded-lg border-l-4 border-[var(--keppel)]">
      <h3 className="font-bold text-xl text-[var(--eerie-black)] mb-4">Currently Exploring:</h3>
      <div className="flex flex-col md:flex-row items-center gap-8">
        <img src={computekSocImage} alt="Computek College SOC Course" className="w-full md:w-1/3 rounded-lg shadow-md" />
        <div className="flex-1">
          <h4 className="font-semibold text-lg text-[var(--eerie-black)]">Security Operations Center Fundamentals</h4>
          <p className="text-sm text-[var(--eerie-black)] mb-2">Present</p>
      ...
      <ul className="list-disc list-inside text-[var(--eerie-black)] space-y-2 mt-6">
